    ...
    section
      ...
      .ui.list
        .item
          .header 6.1 撞牆期
          .list
            .item 6.1.1 不知道如何規畫：如果不知道自學的目標，可以參考
            ...
            .item 6.1.2 不知道未來：如果不知道自學的未來，可以參考
